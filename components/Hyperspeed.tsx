    ...
    useEffect(() => {
        ...
        class App {
            constructor(container, options = {}) {
                ...
                this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5)); // Limit to 1.5 for better performance
                this.composer = new EffectComposer(this.renderer);

                // Style the canvas to ensure proper positioning
            ...
            initPasses() {
                ...
                this.bloomPass = new EffectPass(
                    ...
                    new BloomEffect({
                        ...
                        resolutionScale: 0.5 // Reduce resolution for better performance
                    })
                );
            ...
            onVisibilityChange() {
                // Handle tab visibility changes if needed
            }
